...
function Get-CredentialManagerItem{
param(
	[Parameter(Mandatory = $true)][String]$Target
)
	$nCredPtr = New-Object IntPtr
	$success = [ADVAPI32.Util]::CredRead($Target,1,0,[ref] $nCredPtr)
	...
	if ($success) {
	    ...
	    Write-Error "No credentials where found in Windows Credential Manager for Target: $Target"
	}
}

function Test-CredentialManagerItem{
param(
	[Parameter(Mandatory = $true)][String]$Target
)
	$nCredPtr = New-Object IntPtr
	[ADVAPI32.Util]::CredRead($Target,1,0,[ref] $nCredPtr)	
}