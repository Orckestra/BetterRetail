        ...
        public initialize() {
            ...
            this.VueUpdateAccount = new Vue({
                ...
                data: {
                    ...
                    UpdateAccountState: "",
                    IsLoading: false,
                    DefaultSubstitutionOption: userData.PropertyBag.DefaultSubstitutionOption,
                    SubstitutionOptions: userData.Bag.SubstitutionOptions
                },
                mounted() {
                ...
                methods: {
                    ...
                    updateAccount() {
                        ...
                        let propertyBag = {};
                        if (this.DefaultSubstitutionOption) {
                            propertyBag["DefaultSubstitutionOption"] = this.DefaultSubstitutionOption;
                        }
