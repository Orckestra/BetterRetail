...
module Orckestra.Composer {
    ...
    export class MiniCartController extends Orckestra.Composer.Controller {
        ...
        protected registerSubscriptions(): void {
            ...
            this.eventHub.subscribe(MyAccountEvents.EditOrderChanged, (e: IEventInformation) => this.onEditOrderChanged(e));
        ...
        protected onEditOrderChanged(e: IEventInformation): void {
