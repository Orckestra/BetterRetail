        ...
        public initialize() {
            ...
            let vueBillingAddressMixin = {
                ...
                methods: {
                    ...
                    copyShippingAddress() {
                        let {
                            FirstName, LastName, CountryCode, Line1, City, RegionCode, PostalCode, PhoneNumber, AddressBookId, PhoneRegex
                    ...
                    clearBillingAddress() {
                        ...
                        let {
                            FirstName, LastName, CountryCode, PhoneRegex, PostalCodeRegexPattern, UseShippingAddress
                        } = this.Cart.Payment.BillingAddress;
                        this.Cart.Payment.BillingAddress = {
