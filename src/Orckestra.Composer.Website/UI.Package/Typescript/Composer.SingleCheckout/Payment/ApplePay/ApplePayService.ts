            ...
            return {
                ...
                methods: {
                    ...
                    paymentauthorized(event) {
                        ...
                        this.response = payment.token.paymentData;
                        ComposerClient.post('/api/bambora/authorize', encodeURIComponent(JSON.stringify(payment.token.paymentData)))
                            .then(response => {
                        ...
                        let token = { 
                            ...
                            "paymentMethod": 
                                { "displayName": "Visa 0326", 
                                    ...
                                    "45A5DECFA423822EC63E4B5C008AA29B1F7191BB9B1250472F4B3577F61CAE9B" 
                                };
                        ComposerClient.post('/api/bambora/authorize', encodeURIComponent(JSON.stringify(token.paymentData)))
                        .then(response => {
                            this.response = response.approved + ': ' + response.message;
                            this.Mode.Loading = false;
                        })
