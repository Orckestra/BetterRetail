...
#pragma warning restore 618
        ...
        {
            //TODO - for now there is no way to identify if website user own draft or not, for now we use possible owner names we invetigated, which can be used in AuthToken
