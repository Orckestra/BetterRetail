# Orckestra Better Grocery Starter Site
[![Build Status](https://dev.azure.com/orckestra001/OrckestraCommerce/_apis/build/status/Orckestra.BetterRetailGrocery?api-version=6.0-preview.1&branchName=develop)](https://orckestra001.visualstudio.com/OrckestraCommerce/_build/latest?definitionId=322&branchName=develop)
## Table of Contents
...
- with a direct download [here](https://github.com/Orckestra/BetterRetailGrocery/archive/develop.zip)
...
### SASS
The Grocery Application uses SASS by default. For dynamic SASS compilation into CSS [Orckestra.Web.Css.Sass](https://github.com/Orckestra/CMS-Packages/tree/master/Composite.Web.Css.Sass) package.
...
After successfully deploying the Grocery Application it is configured and ready to use in IIS.


## Development
### Making changes to the dev branch
To make a change to the dev branch create a pull request
### Sync core changes from BetterRetail repository
This repository was initialized from the [BetterRetail `dev` branch](https://github.com/Orckestra/BetterRetail/tree/dev), so it has all its history. If you need to provide some changes to any project except of the **Orckestra.Composer.Grocery** or the **Orckestra.Grocery.Website**, do these changes in  the [BetterRetail repository](https://github.com/Orckestra/BetterRetail) first, and only then sync the changes to this repository. To do this, in your local BetterGrocery repository configure the Git Remote URL to the [BetterRetail repository](https://github.com/Orckestra/BetterRetail).
...
- Open the solution project file **{solution_dir_path}\Orckestra.Grocery.sln** with Visual Studio in Administrator mode
- In Visual Studio select **Debug - Attach to process** and select a **w3wp** process of the intended website

### Cake files
Cake files are used to build and deploy the Grocery Application. 
...
#### Connecting the Grocery App to Azure App Insights
...
## Related projects
The Grocery Application is dependent on [C1 CMS Foundation](https://github.com/Orckestra/C1-CMS-Foundation) and can use [C1 CMS packages](https://github.com/Orckestra/CMS-Packages)
