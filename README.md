...
If the web site deployed using Azure App Service, you could turn on AppInsights directly inside the service. But to have extended RefApp logs or use AppInsights which you have deployed the application locally, you can use an out-of-box RefApp AppInsights logger.
