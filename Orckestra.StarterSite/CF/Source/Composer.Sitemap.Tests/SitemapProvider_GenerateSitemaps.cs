...
namespace Orckestra.Composer.Sitemap.Tests
{
    ...
    public class SitemapProvider_GenerateSitemaps
    {
        ...
        public void WHEN_1003EntriesTotal_1000EntriesPerSitemap_SHOULD_ReturnTwoSitemaps()
        {
            ...
            provider.Setup(p => p.GetEntriesAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CultureInfo>(), 0, numberOfEntriesPerSitemap))
                .Returns(Task.FromResult(Enumerable.Range(1, 1000).Select(i => new SitemapEntry())));
            provider.Setup(p => p.GetEntriesAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CultureInfo>(), 1000, numberOfEntriesPerSitemap))
                .Returns(Task.FromResult(Enumerable.Range(1, 3).Select(i => new SitemapEntry())));

            var sut = _container.CreateInstance<SitemapProvider>();

            // ACT
            var sitemaps = sut.GenerateSitemaps("baseUrl", "scope", new CultureInfo("en")).ToArray();
            ...
            provider.Verify(p => p.GetEntriesAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CultureInfo>(), It.IsAny<int>(), It.IsAny<int>()), Times.Exactly(2));
        }
        ...
        public void WHEN_500EntriesTotal_1000EntriesPerSitemap_SHOULD_ReturnOneSitemap()
        {
            ...
            provider.Verify(p => p.GetEntriesAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<CultureInfo>(), It.IsAny<int>(), It.IsAny<int>()), Times.Once());
        }
        ...
        public void WHEN_BaseUrlIsNull_SHOULD_ThrowArgumentException()
        {
            ...
            // ACT
            Action action = () => sut.GenerateSitemaps(string.Empty, "scope", new CultureInfo("en")).ToArray();
        ...
        public void WHEN_CultureIsNull_SHOULD_ThrowArgumentException()
        {
            ...
            // ACT
            Action action = () => sut.GenerateSitemaps("baseUrl", "scope", null).ToArray();
        ...
        public void WHEN_ScopeIsNull_SHOULD_ThrowArgumentException()
        {
            ...
            // ACT
            Action action = () => sut.GenerateSitemaps("baseUrl", null, new CultureInfo("en")).ToArray();
