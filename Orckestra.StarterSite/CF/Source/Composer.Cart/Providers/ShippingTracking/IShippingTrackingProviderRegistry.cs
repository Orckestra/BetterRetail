...
{
    public interface IShippingTrackingProviderRegistry
    {
        /// <summary>
        ...
        /// <typeparam name="TProvider">Type of the provider. This type needs to derive from <see cref="IShippingTrackingProvider"/>.</typeparam>
        void RegisterProvider<TProvider>(string name) where TProvider : IShippingTrackingProvider;

        /// <summary>
        /// Registers a provider with the given name to resolve the given type.
        /// </summary>
        /// <param name="name">Name that will be used to resolve the provider.</param>
        /// <param name="providerType">Type of the provider. This type needs to derive from <see cref="IShippingTrackingProvider"/>.</param>
