...
///<reference path='../../../Typescript/MonerisCanadaPaymentProvider.ts' />
///<reference path='../../../Typescript/providers/SavedCreditCardMonerisCanadaPaymentProvider.ts' />
///<reference path='../../../Typescript/ICreateVaultTokenOptions.ts' />
///<reference path='../../../Typescript/IMonerisResponseData.ts' />
///<reference path='../../../Typescript/MonerisPaymentService.ts' />
