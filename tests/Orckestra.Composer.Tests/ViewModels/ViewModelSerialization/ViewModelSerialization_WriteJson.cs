...
namespace Orckestra.Composer.Tests.ViewModels.ViewModelSerialization
{
    public class ViewModelSerializationWriteJson : SetupForViewModelSerializationTest
    {
        ...
        {
            JsonFromCustomSerializer = JsonConvert.SerializeObject(new object(), Formatting.Indented, new Composer.ViewModels.ViewModelSerialization(MetadataRegistry.Object));
